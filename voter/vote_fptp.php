...
// Check if already voted FPTP
if (hasVoted($voter_id, 'FPTP')) {
    $_SESSION['error'] = 'You have already cast your FPTP vote';
...
$candidates_query = "SELECT c.*, p.party_name, p.party_logo 
                     ...
                     WHERE c.constituency_id = ? AND c.election_type = 'FPTP'";
$stmt = $db->prepare($candidates_query);
$stmt->bind_param("i", $voter['constituency_id']);
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (!verifyCSRFToken($_POST['csrf_token'])) {
        ...
        $verify_query = "SELECT id, candidate_name FROM candidates WHERE id = ? AND constituency_id = ? AND election_type = 'FPTP'";
        $verify_stmt = $db->prepare($verify_query);
        $verify_stmt->bind_param("ii", $candidate_id, $voter['constituency_id']);
        $verify_stmt->execute();
        $candidate = $verify_stmt->get_result()->fetch_assoc();
        
        if ($candidate) {
            // Record vote
            $vote_query = "INSERT INTO votes (voter_id, candidate_id, election_type) VALUES (?, ?, 'FPTP')";
            ...
            if ($vote_stmt->execute()) {
                ...
                $_SESSION['success'] = 'Your FPTP vote has been recorded successfully!';
                header("Location: vote_success.php?type=FPTP");
                exit();
            } else {
...
<head>
    ...
    <title>FPTP Voting - VoteNepal</title>
...
<body>
    <div class="voting-container">
        <div class="header">
            <h1><i class="fas fa-vote-yea"></i> FPTP Voting</h1>
        ...
        <?php if ($candidates->num_rows == 0): ?>
            <div class="alert alert-warning">
                ...
                No candidates found for your constituency. Please contact election commission.
            </div>
        <?php else: ?>
    ...
    <div class="modal" id="confirmModal">
        <div class="modal-content">
            ...
            <p>Are you sure you want to cast your FPTP vote for this candidate? This action cannot be undone.</p>
    ...
    <script>
        ...
        function showConfirmModal() {
            ...
            infoDiv.innerHTML = `
                ...
                <p><strong>Election:</strong> FPTP</p>
            `;
